...
(function() {
	...
	var resize = function() {
		if (!$phone.is(":visible") && opened) close(true);
	};
...
(function() {
	...
	slider
		.on("slideChange", function() {
			...
			if (index==0) {
				$slider
					.removeClass("show--coins")
					.addClass("lights--car");
			} else {
				$slider
					.removeClass("lights--car")
					.addClass("show--coins");
			}
		})
		.on("lazyImageReady", function(slideEl, imageEl) {
			if ($(slideEl).hasClass("promo-item--1")) $slider.addClass("show--car lights--car");
